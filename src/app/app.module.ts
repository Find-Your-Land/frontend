...
import { FindArtistComponent } from './pages/find-artist/find-artist.component';
import { AppHeaderArtistComponent } from './cmps/app-header-artist/app-header-artist.component';
import { ArtistListComponent } from './cmps/artist-list/artist-list.component';
import { ArtistPreviewComponent } from './cmps/artist-preview/artist-preview.component';
import { ArtistImgCarouselComponent } from './cmps/artist-img-carousel/artist-img-carousel.component';
import { ArtistHeaderFilterComponent } from './cmps/artist-header-filter-folder/artist-header-filter/artist-header-filter.component';
import { ArtistHeaderFilterGuestModalComponent } from './cmps/artist-header-filter-folder/artist-header-filter-guest-modal/artist-header-filter-guest-modal.component';
import { ArtistHeaderFilterModalComponent } from './cmps/artist-header-filter-folder/artist-header-filter-modal/artist-header-filter-modal.component';
import { ArtistRegionModalComponent } from './cmps/artist-header-filter-folder/artist-region-modal/artist-region-modal.component';
import { ArtistSearchPlaceModalComponent } from './cmps/artist-header-filter-folder/artist-search-place-modal/artist-search-place-modal.component';
@NgModule({
  declarations: [
    AppComponent,
    AppHeaderComponent,
    ...
    StaysMapComponent,
    FindArtistComponent,
    AppHeaderArtistComponent,
    ArtistListComponent,
    ArtistPreviewComponent,
    ArtistImgCarouselComponent,
    ArtistHeaderFilterComponent,
    ArtistHeaderFilterGuestModalComponent,
    ArtistHeaderFilterModalComponent,
    ArtistRegionModalComponent,
    ArtistSearchPlaceModalComponent,
