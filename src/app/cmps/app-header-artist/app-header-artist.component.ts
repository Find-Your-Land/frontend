...
@Component({
  ...
  templateUrl: './app-header-artist.component.html',
  styleUrls: ['./app-header-artist.component.scss']
})
export class AppHeaderArtistComponent {
  constructor(
  ...
  onNavigateToHost() {
    if (!this.userService.getUser()) this.snackBar.open('Por favor, faca login primeiro', 'Close', { duration: 3000 })
