...
const routes: Routes = [
  ...
  {
    path: 'find-artist/:artistId',
    loadChildren: () => import('./lazy-loading/lazy-loading.module-artist').then(m => m.LazyLoadingModuleArtist),
    resolve: { artist: ArtistResolver },
  },
  { path: 'find-artist', component: FindArtistComponent },
